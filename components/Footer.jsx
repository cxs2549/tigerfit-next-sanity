...
const navigation = {
    solutions: [
      ...
      { name: 'Submit a Fake', href: '#' },
    ],
    support: [
      { name: 'Careers', href: '#' },
      { name: 'Student Discount', href: '#' },
      { name: 'Veterans Discount', href: '#' },
      { name: 'Factory List', href: '#' },
    ],
    company: [
      { name: 'About', href: '#' },
      { name: 'Blog', href: '#' },
      ...
      <footer className="bg-white border-t" aria-labelledby="footer-heading">
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            <p className="text-xs text-gray-400 xl:text-center">&copy; 2022 CSD. All rights reserved.</p>
          </div>
        </div>
      </footer>
    )
